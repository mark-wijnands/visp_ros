...
main( int argc, char **argv )
{
  ...
  try
  {
    ...
    plotter->setTitle( 4, "Command torque" );
    plotter->initGraph( 4, 7 );
    plotter->setLegend( 4, 0, "t1" );
    plotter->setLegend( 4, 1, "t2" );
    plotter->setLegend( 4, 2, "t3" );
    plotter->setLegend( 4, 3, "t4" );
    plotter->setLegend( 4, 4, "t5" );
    plotter->setLegend( 4, 5, "t6" );
    plotter->setLegend( 4, 6, "t7" );
    ...
    while ( !final_quit )
    {
      ...
      plotter->plot( 4, time_cur, tau_cmd);        
      // plotter->plot( 5, time_cur, dx_ed);        
      // plotter->plot( 6, time_cur, ddx_ed);        
    ...
    if ( opt_save_data )
    {
      ...
      plotter->saveData( 4, "sim-cart-tau-cmd.txt", "# " );
      // plotter->saveData( 5, "sim-cart-dx-ed.txt", "# " );
      // plotter->saveData( 6, "sim-cart-ddx-ed.txt", "# " );
